...
public class ActionDefinition extends ShardActionDefinitionBase {
    ...
    private ActionDefinition() {
        super(TransportAction.class, "indices/termlist", false, ShardActionDefinitionBase.ShardsEnum.PRIMARY, false);
    }

    @Override
    public TransportItemBase createTransportItem() {
        return new TermlistTransportItem(this);
    }

    @Override
    public TransportItemBase createTransportItem(StreamInput in)  throws IOException {
        return new TermlistTransportItem (this, in);
    }
