...
import nl.bitmanager.elasticsearch.analyses.ShingleFilter.Factory;
...
public class WordDelimiterGraphTokenFilterFactory extends AbstractMultiTermTokenFilterFactory {
    ...
    public WordDelimiterGraphTokenFilterFactory(IndexSettings indexSettings, Environment env, String name, Settings settings) {
        ...
        // If set, ignores all tokens that have the keyword attribute
        flags |= getFlag(512, settings, "ignore_keywords", true);
    ...
    public static class Provider implements AnalysisProvider<TokenFilterFactory> {
        ...
        public TokenFilterFactory get(IndexSettings indexSettings, Environment env, String name, Settings settings) throws IOException {
            return new WordDelimiterGraphTokenFilterFactory(indexSettings, env, name, settings);
        }
